		...
		if ($f['filed_type'] == 'file') {
			...
			$contents .= '<td><?php echo %module["'.$f['name'].'"] ?></td>';
													...
													<td>
														...
														?>
														<a href="<?php echo base_url() ?>admin/'.$controller_name.'/edit/<?php echo %module["id"] ?>"><button class="btn btn-info btn-circle material-ripple"><i class="material-icons">mode_edit</i></button></a>
														<?php } ?>
														<?php 
															if (%permission["deleted"] == "1") {
														?>
		                                                <a href="<?php echo base_url() ?>admin/'.$controller_name.'/delete/<?php echo %module["id"] ?>"><button class="btn btn-danger btn-circle material-ripple"><i class="material-icons">delete_forever</i></button></a>
		                                                <?php } ?>
	                                                </td>
	                                                <?php } ?>
												</tr>
