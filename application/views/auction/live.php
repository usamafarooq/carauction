        ...
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <div class="section-title">
              <h3>I-Bid Live - All Auctions List</h3>
            </div>
          </div>
        </div>
        <div class="row bg-opt-result">
          <div class="bg-opt">
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="result-detail"><h4>Showing results  ( 1 - 10 ) of <span>  50000+</span></h4></div>  
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="featured-col">
              <div class="box">
                ...
                <div class="box-content">
                  <ul class="icon">
                    <li><a href="<?php echo base_url($l['images']) ?>" data-lightbox="lightbox-1" data-title="My caption"><i class="fa fa-search"></i></a></li>
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <ul>
                      ...
                      <li>Time Left: <span><?php echo get_single_difrreance($l['Sale_Date']); ?></span></li>
                    </ul>
