        ...
        <div class="content-header">
            ...
            <div class="header-title">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Models</li>
                </ol>
            </div>
        </div>
        <!-- /. Content Header (Page header) -->

        <form method="post" action="<?php echo base_url() ?>admin/models/update" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body"><div class="form-group row">
                                ...
                                <label for="example-text-input" class="col-sm-3 col-form-label">Name<span class="required">*</span></label>
                                        <div class="col-sm-9">
<?php $Name = explode(",", $models["Name"]) ?>
                                        <input class="form-control" name="Name" type="text" value="<?php echo $models["Name"] ?>" id="example-text-input" placeholder="" required=""></div>
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="Make" required="">
                                                <option>Select Make</option><?php foreach ($table_makes as $t) {?>
                                                    <option value="<?php echo $t["id"] ?>" <?php if($t["id"] == $models["Make"]) echo "selected" ?>><?php echo $t["Name"] ?></option>
                                               <?php } ?></select>
                                        </div>
