...
class Main_model extends MY_Model
{
	...
	{
		$this->db->select('u.*,group_concat(ud.file separator ",") as document,group_concat(ud.id separator ",") as document_id, count(w.id) as watchlist, count(s.id) as save_search')
				 ->from('users u')
